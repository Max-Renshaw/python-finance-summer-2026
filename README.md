...
2. **High-Frequency Telemetry Benchmarking:**
   * **Data Extraction:** Leveraging the `FastF1` API to parse spatial coordinate arrays, velocity profiles, and sub-second driver inputs from the 2020 Nürburgring Qualifying session.
   * **Variance Analytics:** Modeled the statistical variance of driver throttle and braking applications through high-g corners to evaluate and map mechanical risk-reward profiles.

## Technical Tech Stack
* **Language:** Python
* **Data Science:** Pandas & NumPy (Matrix manipulation, percentage return arrays, covariance calculation)
* **Frontend UI:** Streamlit Framework (Dynamic multi-tab software architecture)
